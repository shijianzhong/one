...
impl Translations {
    ...
    pub const SKILLS_HINT: (&'static str, &'static str) = (
        "上传并管理技能包（.skill / .zip）",
        "Upload and manage skill packages (.skill / .zip)",
    );
    pub const UPLOAD_SKILL_PACKAGE: (&'static str, &'static str) =
        ("上传技能包", "Upload Skill Package");
    pub const UPLOAD: (&'static str, &'static str) = ("上传", "Upload");
    pub const NO_SKILLS: (&'static str, &'static str) =
        ("还没有安装任何技能。", "No skills installed yet.");
    ...
    pub const DELETE_WORKSPACE: (&'static str, &'static str) =
        ("删除 Workspace", "Delete Workspace");
    ...
    pub const WAITING_FOR_AI_RESPONSE: (&'static str, &'static str) =
        ("等待 AI 回复...", "Waiting for AI response...");
    pub const GENERATING_RESPONSE: (&'static str, &'static str) =
        ("生成回复中...", "Generating response...");
    ...
    // Model config dialog
    pub const MODEL_SERVICE_CONFIG: (&'static str, &'static str) =
        ("模型服务配置", "Model Service Config");
    ...
    pub const EXPORT_MARKDOWN_TITLE: (&'static str, &'static str) =
    ...
    pub const CONTINUING_CLAUDE_RUN: (&'static str, &'static str) =
        ("继续运行中", "Continuing Claude Code run");
    ...
    pub const STREAMING_RESPONSE: (&'static str, &'static str) =
        ("正在流式输出", "Streaming response");
    pub const CLAUDE_STARTED_LIVE_CONTENT: (&'static str, &'static str) = (
        "Claude Code 开始返回实时内容",
    ...
    pub const CLAUDE_CODE_RUNNING: (&'static str, &'static str) =
        ("Claude Code 运行中", "Claude Code is running");
    pub const CLAUDE_WAITING_FOR_ANSWER: (&'static str, &'static str) =
        ("等待你的回答", "Claude Code is waiting for your answer");
    ...
    pub const INSTRUCTION_SUBMITTED: (&'static str, &'static str) =
        ("已提交指令", "Instruction submitted");
    pub const PREVIEW_AFTER_RUN_NOTE: (&'static str, &'static str) = (
        "预览将在运行完成后准备",
        "Preview will be prepared after the run completes",
    );
    pub const RUN_COMPLETED: (&'static str, &'static str) = ("运行完成", "Run completed");
    pub const GENERATED_CHARACTERS: (&'static str, &'static str) =
        ("生成字符数", "Generated characters");
    pub const RUN_FAILED: (&'static str, &'static str) = ("运行失败", "Run failed");
    pub const CLAUDE_EXECUTION_ERROR: (&'static str, &'static str) =
        ("Claude Code 执行错误：", "Claude Code execution error: ");
    ...
    pub const OPENED_PREVIEW_URL: (&'static str, &'static str) = (
        "已在外部浏览器打开预览链接",
    ...
    pub const SERVING_WORKSPACE_ROOT: (&'static str, &'static str) =
        ("正在托管工作空间根目录", "Serving workspace root");
    pub const FAILED_TO_START_PREVIEW_SERVER: (&'static str, &'static str) =
        ("预览服务启动失败", "Failed to start preview server");
    pub const PREVIEW_DIR_MISSING: (&'static str, &'static str) =
        ("预览目录不存在", "Preview directory does not exist");
    pub const NO_PREVIEWABLE_HTML: (&'static str, &'static str) = (
        "该工作空间未找到可预览的 HTML 文件。",
        "No previewable HTML file found in this workspace.",
    );
    ...
    pub const NO_PREVIEW_INFO: (&'static str, &'static str) =
        ("暂无预览信息", "No preview information");
    ...
    pub const NO_PENDING_QUESTIONS: (&'static str, &'static str) = (
        "暂无待回答的问题。",
        "No pending questions from Claude Code.",
    );
    ...
    pub const COMMAND_NOT_STARTED: (&'static str, &'static str) =
        ("Claude 命令尚未开始", "Claude command has not started yet");
    pub const TIMELINE: (&'static str, &'static str) = ("时间线", "Timeline");
    pub const NO_CLAUDE_RUN_YET: (&'static str, &'static str) =
        ("暂无 Claude 运行记录", "No Claude run yet");
    ...
    pub const ANSWER_CLAUDE_QUESTION: (&'static str, &'static str) =
        ("回答 Claude 的问题...", "Answer Claude's question...");
    pub const WORKDIR: (&'static str, &'static str) = ("工作目录", "Workdir");
    pub const NO_ARTIFACTS_YET: (&'static str, &'static str) = (
        "该任务暂无产物。",
        "No artifacts detected for this task yet.",
    );
