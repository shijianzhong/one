...
impl Translations {
    ...
    pub const UNDERSTANDING_INTENT: (&'static str, &'static str) =
        ("理解意图中...", "Understanding intent...");
    pub const INTENT_UNDERSTOOD: (&'static str, &'static str) =
        ("意图理解完成", "Intent understood");
    pub const INTENT_FAILED: (&'static str, &'static str) =
        ("意图理解失败", "Intent understanding failed");
    ...
    pub const NO_REFERENCES_YET: (&'static str, &'static str) =
        ("暂无参考资料", "No references yet");
    pub const FEATURE_IN_PROGRESS: (&'static str, &'static str) =
